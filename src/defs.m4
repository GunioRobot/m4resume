...
`__RDFA_CANDIDATE_GITHUB',`<a property="foaf:currentProject" content="CANDIDATE_GITHUB" rel="foaf:currentProject" href="CANDIDATE_GITHUB" about="CANDIDATE_GITHUB">CANDIDATE_GITHUB</a>',
`__RDFA_RUL',`<a property="foaf:schoolname" href="http://www.rul.nl">RUL</a>',
`__RDFA_CANDIDATE_HOMEPAGE',`<a rel="foaf:homepage" property="foaf:weblog" href="CANDIDATE_HOMEPAGE">CANDIDATE_HOMEPAGE</a>',
