...
define(`RDFA_CISCO_RECENT_ACHIEVEMENTS',``Authored 5–point, 2–year legacy systems migration strategy to move all backbone mail services to a standardized, turnkey environment.  Implementation completed 2008',
...
`Through efforts in the previous 6 years, reduced head-count to 1 full time employee and a vendor team.  Realized net savings in excess of `'320`,'000'USD')
